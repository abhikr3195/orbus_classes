...
console.log(arr1[0]);
console.log(typeof arr1); // This will return Object

let obj1 = {};
console.log(typeof obj1); //object; Class name is Object
console.log(obj1 instanceof Object); //  Return true
...
const handleSubmit = () => {
  ...
  if (usernameInput.value === "") {
    errorContainer.innerHTML = "<strong>Please enter user name!</strong>";
    errorContainer.style.color = "red";
    return false;
  }

  if (usernameInput.value.length > 10) {
    errorContainer.innerHTML = "<strong>Length of user name should not be more than 10 characters!</strong>";
    errorContainer.style.color = "red";
    return false;
  }

  // Clear previous error message if all is valid
